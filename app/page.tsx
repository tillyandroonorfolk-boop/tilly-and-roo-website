export default function Home() {
  const instaLink = "https://www.instagram.com/tillyandroonorfolk";
  ...
  const Card = (name: string, description: string, notes: string) => (
    <div className="bg-white p-6 md:p-10 rounded-xl border border-black/5 text-center shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-lg">
      ...
      <div className="mt-6 pt-6 border-t border-black/5">
        <p className="text-xs tracking-[0.25em] text-[#7C8A6A] uppercase mb-4">
          {notes}
        </p>
    ...
    <main className="min-h-screen bg-white text-black">
      ...
      <section className="max-w-4xl mx-auto px-6 py-20 md:py-32 text-center">
       <h1 className="text-3xl md:text-6xl tracking-[0.04em] font-light mb-6">
        ...
        <p className="text-lg md:text-2xl tracking-[0.15em] mb-4">
          Fragrance for Calm Interiors
        </p>

        <p className="text-sm tracking-[0.2em] text-black/60">
